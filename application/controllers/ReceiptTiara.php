...
class ReceiptTiara extends Admin {
	...
	public function index($date = '', $date1 = '')
	{
		...
		$dataCt = $this->dashboard_model->getDataReceiptTiara($date,$date1);
		...
		$this->load->view('receiptTiara', Array('data' => $data, 'date' => $date, 'dataCt' => $dataCt, 'username' => $username,'date1' => $date1));
    ...
    public function download($date = '', $date1 = '')
	{
		...
		$this->dashboard_model->downloadDataReceiptTiara($date, $date1);
	}    
