...
class DetailSetoranSimtax extends Admin {
	...
	public function index($date = '', $date1 = '')
	{
		...
		$dataCt = $this->dashboard_model->getDataSetoranSimtax($date, $date1);
		
		
		$this->load->view('header');
		$this->load->view('detailSetoranSimtax', Array('data' => $data, 'date' => $date, 'dataCt' => $dataCt, 'username' => $username, 'date1' => $date1));
	...
	public function download($date = '', $date1 = '')
	{
		...
		$this->dashboard_model->downloadDataSetoranSimtax($date, $date1);
	}
