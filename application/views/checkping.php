                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="id_privilege" class="form-control">
                          	<option value="6" <?php if(isset($user['id_privilege']) && $user['id_privilege'] == 6) echo 'selected';?>>Operasi</option>
                          	<option value="7" <?php if(isset($user['id_privilege']) && $user['id_privilege'] == 7) echo 'selected';?>>Checker</option>
                          	<option value="8" <?php if(isset($user['id_privilege']) && $user['id_privilege'] == 8) echo 'selected';?>>ITMS</option>
