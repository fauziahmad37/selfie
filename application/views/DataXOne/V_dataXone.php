		  ...
		  <div cla  ss="row">
		  	<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
		  			<form id="demo-form2" autocomplete="off" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('/C_setoran/dataXOne'); ?>" method="post">
					  ...
					  <div class="form-group">                   	
						...
						<div class="col-md-6 col-sm-6 col-xs-9">
						 <select name="id_pool" id="id_pool" required="required" class="form-control col-md-7 col-xs-12">
							<option value="17">Jagakarsa</option>
							<option value="15">Bintaro</option>
							<option value="16">Ciganjur</option>
							<option value="22">Cipondoh B</option>
							<option value="23">Cipondoh C</option>
							<option value="19">Star</option>
							<option value="20">Joglo Lama</option>
							<option value="2">Bekasi B</option>
							<option value="3">Bekasi C</option>
							<option value="24">Tangsel</option>
							<option value="8">Depok</option>
							<option value="18">Joglo Baru</option>
