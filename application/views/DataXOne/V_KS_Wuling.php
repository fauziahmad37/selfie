        ...
        <div class="right_col" role="main">
		  <div cla  ss="row">
		  	<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>DATA KS OPERASI WULING SPJ H-1</h2>
		                                ...
		                                <tbody>
		                                	<?php foreach ($data_jagakarsa AS $row) { ?>
		                                   	 <tr class="odd gradeX">
		                                         ...
		                                         <td align='center'><?php echo $row['NAMA_SETOR'];?></td>
		                                         <td align='center'><?php echo number_format($row['TOTAL_KS_TERBIT']);?></td>
		                                    </tr>
		                                    <?php } ?>
		                                </tbody>
		                            </table>
