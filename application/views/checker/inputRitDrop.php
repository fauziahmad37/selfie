        ...
        <div class="right_col" role="main">
		  <div cla  ss="row">
		  	<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Input Rit Drop</h2>
                    <div class="clearfix"></div>
                  </div>
				  <div id="ajax-modal-savings" class="modal fade" role="dialog" tabindex="-1" aria-hidden="true" style="display: none;"></div>                  
                  <div class="x_content">
		  			<form id="demo-form2" autocomplete="off" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('/Checker/inputRitDrop'); ?>" method="post">
                                          ...
                                          <?php if ($flagProses > 0) { 
											...
											echo "
													<table >
														...
														<tr height='100%'>
															<td align='right'><input type='checkbox' name='stnk' value='TIDAK ADA'>
															<td>Tidak Ada</td>
														</tr>
														<tr height='100%'>
															<td>KEUR</td>
														...
														<tr height='100%'>
															<td align='right'><input type='checkbox' name='keur' value='TIDAK ADA'>
															<td>Tidak Ada</td>
														</tr>
														<tr height='100%'>
															<td>KP</td>
														...
														<tr height='100%'>
															<td align='right'><input type='checkbox' name='kp' value='TIDAK ADA'>
															<td>Tidak Ada</td>
														</tr>
														<tr height='100%'>
															<td>TERA</td>
														...
														<tr height='100%'>
															<td align='right'><input type='checkbox' name='tera' value='TIDAK ADA'>
															<td>Tidak Ada</td>
														</tr>
														<tr height='100%'>
