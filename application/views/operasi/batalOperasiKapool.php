        ...
        <div class="right_col" role="main">
		  <div cla  ss="row">
		  	<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Batal Operasi (Khusus Kapool)</h2>
                    <div class="clearfix"></div>
                  </div>
				  <div id="ajax-modal-savings" class="modal fade" role="dialog" tabindex="-1" aria-hidden="true" style="display: none;"></div>                  
                  <div class="x_content">
		  			<form id="demo-form2" autocomplete="off" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('/Operasi/batalOperasiPool'); ?>" method="post">
					  ...
					  <div class="form-group">
					   ...
					   <div class="form-group">                   	
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="no_pintu">Masukan Alasan Batal Operasi <span class="required">*</span>
						</label>
						<div class="col-md-6 col-sm-6 col-xs-9">
						  <input type="text" id="v_alasan" name="v_alasan" placeholder="Tulis Alasan Dengan Jelas (Min 16 Karakter)	" required="required" class="form-control col-md-7 col-xs-12" />
						</div>   
                   	  </div>
                      ...
                      <div class="form-group">                   	
						...
						<div class="col-md-6 col-sm-6 col-xs-9">
						  ...
						  <input type="hidden" id="alasanBatalOperasiProses" name="alasanBatalOperasiProses" value="<?php echo $alasanBatalOperasiProses;?>"/>
