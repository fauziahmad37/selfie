		                                ...
		                                <tbody>
		                                	<?php
												...
												<td align='center'><?php echo $i; ?></td>
		                                   	 	<td align='center'><?php echo $val['vehicle_id'];?></td>
		                                        <td align='center'><?php echo $val['license_plate_no'];?></td>
		                                        <td align='center'><?php echo $val['lat'];?></td>
		                                        <td align='center'><?php echo $val['date_time'];?></td>
		                                        <td align='center'><?php echo $val['lng'];?></td>
		                                        <td align='center'><?php echo $val['km'];?></td>
		                                    </tr>
		                                    <?php $i++; } ?>
		                                </tbody>
		                            </table>
