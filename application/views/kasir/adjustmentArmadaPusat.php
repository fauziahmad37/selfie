        ...
        <div class="right_col" role="main">
		  <div class="row">
		  	<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Adjusment Armada Tidak Ada di Pusat</h2>
                  ...
                  <div class="x_content">
		  			...
		  			action="<?php echo site_url('Kasir/adjustmentArmadaTidakAdaDiPusat'); ?>" method="post">
                      ...
                      <form id="demo-form2" autocomplete="off" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('Kasir/adjustmentTidakAdaDiPool'); ?>" method="post">
                      <div class="form-group">                   	
