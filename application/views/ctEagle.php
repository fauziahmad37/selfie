        ...
        <div class="right_col" role="main">
          ...
          <div class="row top_tiles">
          	<div class="col-md-12 col-sm-12 col-xs-12 tile">
          		...
          		<h2>Credit Ticket Eagle <?php $datetime = new DateTime($date);?></h2>
          		</div>
          ...
          <div class="row">
            ...
            <div class="x_panel tile">
                <div class="x_title">
                  <h2>Data Detail Credit Ticket Eagle</a></h2>                 
		  ...
		  $(document).ready(function(){
			...
			$('.btnSubmit').on('click', function (e) {
				...
				if(yy > 0 && mm > 0 && dd > 0 && yy1 > 0 && mm1 > 0 && dd1 > 0){
					window.location = "<?php echo site_url('/CTEagle/index/');?>"+yy+'-'+mm+'-'+dd+'/'+yy1+'-'+mm1+'-'+dd1;
			...
			$('.btnSubmit1').on('click', function (e) {
				...
				var yy1 = date1.getFullYear();
				if(yy > 0 && mm > 0 && dd > 0 && yy1 > 0 && mm1 > 0 && dd1 > 0){
					window.location.href  = "<?php echo site_url('/CTEagle/download/');?>"+yy+'-'+mm+'-'+dd+'/'+yy1+'-'+mm1+'-'+dd1;
				}
				else 
					alert('Please input date');
			});
			...
			$('.btnUpdate').on('click', function (e) {
				window.location = "<?php echo site_url('/CTEagle/update_revenue_now?start='.$date);?>";
			});
