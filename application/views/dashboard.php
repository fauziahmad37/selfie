        ...
        <div class="right_col" role="main">
          ...
          <div class="row top_tiles">
          	<div class="col-md-12 col-sm-12 col-xs-12 tile">
          		...
          		<h2>Dashboard - <?php $datetime = new DateTime($date); echo $datetime->format('l, j F Y'); ?></h2>
				</div>
          ...
          <div class="row tile_count">
            <div class="col-md-4 col-sm-4 col-xs-4 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Credit Ticket</span>
              <div class="count"><?php echo $dataCt; ?></div>
              
            </div>
            <div class="col-md-4 col-sm-4 col-xs-4 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Buka Sos</span>
              <div class="count"><?php echo $dataBukaSos; ?></div>
              
            </div>
            <div class="col-md-4 col-sm-4 col-xs-4 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Buka Bs</span>
              <div class="count"><?php echo $dataBukaBs; ?></div>
              
            </div>  
			<div class="col-md-4 col-sm-4 col-xs-4 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Duplicate Spj</span>
              <div class="count"><?php echo $dataDuplicateSpj; ?></div>
