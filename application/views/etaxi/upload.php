	...
	<div class="right_col" role="main">
		<div class="row">
			<div class="x_panel tile" id="print_area">
				<div class="x_title">
					<h2>Upload Foto Etaxi</h2>
					<div class="clearfix"></div>
				</div>
				
					<div class="x_content">
						<form id="form-model" autocomplete="off" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('/Uploads/'); ?>" method="post">
