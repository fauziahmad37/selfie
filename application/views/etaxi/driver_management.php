		...
		<div class="row">
			<div class="x_panel tile" id="print_area">
				<div class="x_title">
					...
					<div class="x_content">
						<form id="form-model" autocomplete="off" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('/Etaxi/driver_management/'); ?>" method="post">
