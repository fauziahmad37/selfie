        ...
        <div class="right_col" role="main">
          ...
          <div class="row top_tiles">
          	<div class="col-md-12 col-sm-12 col-xs-12 tile">
          		...
          		<h2>Dashboard Operation Etaxi - <?php $datetime = new DateTime($date); echo $datetime->format('l, j F Y'); ?></h2>
				</div>
          ...
          <div class="row tile_count">
            <div class="col-md-2 col-sm-2 col-xs-2 tile_stats_count	">
              <span class="count_top"><i class="fa fa-user"></i> Pondok Bambu</span>
			  <div class="count_top"><i class="fa fa-taxi"></i> Total SPJ Aktif</div>
              <div class="count"><?php echo $spj_pd_bambu['count']; ?></div><br/>
			  <div class="count_top"><i class="fa fa-taxi"></i> Total Cetak SPJ Hari Ini</div>
              <div class="count"><?php echo $cetakSpj_pd_bambu['count']; ?></div><br/>
			  <div class="count_top"><i class="fa fa-taxi"></i> Unit SOS Hari Ini</div>
			  <div class="count"><?php echo $sos_pd_bambu['count']; ?></div><br/>
			   <div class="count_top"><i class="fa fa-taxi"></i> Unit TP Hari Ini</div>
			  <div class="count"><?php echo $tp_pd_bambu['count']; ?></div><br/>
			  <div class="count_top"><i class="fa fa-taxi"></i> Unit Belum Pulang 5 Hari</div>
              <div class="count"><?php echo $spj_5days_pd_bambu['count']; ?></div><br/>
            </div>
			
			 <div class="col-md-2 col-sm-2 col-xs-2 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Pekapuran</span>
			  <div class="count_top"><i class="fa fa-taxi"></i> Total SPJ Aktif</div>
              <div class="count"><?php echo $spj_pekapuran['count']; ?></div><br/>
			   <div class="count_top"><i class="fa fa-taxi"></i> Total Cetak SPJ Hari Ini</div>
			   <div class="count"><?php echo $cetakSpj_pekapuran['count']; ?></div><br/>
			  <div class="count_top"><i class="fa fa-taxi"></i> Unit SOS Hari Ini</div>
			  <div class="count"><?php echo $sos_pekapuran['count']; ?></div><br/>
			   <div class="count_top"><i class="fa fa-taxi"></i> Unit TP Hari Ini</div>
			  <div class="count"><?php echo $tp_pekapuran['count']; ?></div><br/>
			    <div class="count_top"><i class="fa fa-taxi"></i> Unit Belum Pulang 5 Hari</div>
              <div class="count"><?php echo $spj_5days_pekapuran['count']; ?></div><br/>
            </div>
			
			 <div class="col-md-2 col-sm-2 col-xs-2 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Cipayung</span>
			  <div class="count_top"><i class="fa fa-taxi"></i> Total SPJ Aktif</div>
              <div class="count"><?php echo $spj_cipayung['count']; ?></div><br/>
			   <div class="count_top"><i class="fa fa-taxi"></i> Total Cetak SPJ Hari Ini</div>
			    <div class="count"><?php echo $cetakSpj_cipayung['count']; ?></div><br/>
			  <div class="count_top"><i class="fa fa-taxi"></i> Unit SOS Hari Ini</div>
			  <div class="count"><?php echo $sos_cipayung['count']; ?></div><br/>
			    <div class="count_top"><i class="fa fa-taxi"></i> Unit TP Hari Ini</div>
			  <div class="count"><?php echo $tp_cipayung['count']; ?></div><br/>
			   <div class="count_top"><i class="fa fa-taxi"></i> Unit Belum Pulang 5 Hari</div>
              <div class="count"><?php echo $spj_5days_cipayung['count']; ?></div><br/>
            </div>
			
			 <div class="col-md-2 col-sm-2 col-xs-2 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Jagakarsa</span>
			  <div class="count_top"><i class="fa fa-taxi"></i> Total SPJ Aktif</div>
              <div class="count"><?php echo $spj_jagakarsa['count']; ?></div><br/>
			   <div class="count_top"><i class="fa fa-taxi"></i> Total Cetak SPJ Hari Ini</div>
			    <div class="count"><?php echo $cetakSpj_jagakarsa['count']; ?></div><br/>
			  <div class="count_top"><i class="fa fa-taxi"></i> Unit SOS Hari Ini</div>
			  <div class="count"><?php echo $sos_jagakarsa['count']; ?></div><br/>
			   <div class="count_top"><i class="fa fa-taxi"></i> Unit TP Hari Ini</div>
			  <div class="count"><?php echo $tp_jagakarsa['count']; ?></div><br/>
			   <div class="count_top"><i class="fa fa-taxi"></i> Unit Belum Pulang 5 Hari</div>
              <div class="count"><?php echo $spj_5days_jagakarsa['count']; ?></div><br/>
            </div>
